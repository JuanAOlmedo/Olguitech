...
class ContactMailerPreview < ActionMailer::Preview
    ...
    def contacto
        ...
        ContactMailer.contacto(user, preference.localized_title, preference2.localized_title,
                               message)
    end
    ...
    def admin_contacto
        ...
        ContactMailer.admin_contacto(user, preference.localized_title, preference2.localized_title,
                                     message)
    end
end
