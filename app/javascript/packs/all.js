...
window.onclick = function(event) {
  if (!event.target.matches(".dropdown") && dropdown.classList.contains('show')) {
...
var articlesHoverableDiv = document.querySelector(".articles-hoverable-div")
var proyectsHoverableDiv = document.querySelector(".proyects-hoverable-div")

function lazyload2 () {
  var lazyloadImages2 = document.querySelectorAll("img.articles-lazy");  
...
function lazyload3 () {
  var lazyloadImages3 = document.querySelectorAll("img.proyects-lazy"); 
