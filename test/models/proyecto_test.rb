...
class ProyectoTest < ActiveSupport::TestCase
    ...
    test 'should change title language with locale' do
        ...
        assert_equal('Lorem Ipsum', @proyecto.get_title)

        I18n.locale = :en

        assert_equal('English - Lorem Ipsum', @proyecto.get_title)
    end
    ...
    test 'should get content and change it with locale' do
        ...
        assert_equal(ActionText::RichText.find(3), @proyecto.get_content)
