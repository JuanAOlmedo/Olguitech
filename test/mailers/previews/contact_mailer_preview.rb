...
class ContactMailerPreview < ActionMailer::Preview
    ...
    def contacto
        ...
        ContactMailer.contacto(user, preference.get_title, preference2.get_title, message)
    end
    ...
    def admin_contacto
        ...
        ContactMailer.admin_contacto(user, preference.get_title, preference2.get_title, message)
    end
end
