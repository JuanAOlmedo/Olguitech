...
let formTitle = document.querySelector("#product_title"),
    formDescription = document.querySelector("#product_description"),
    formContent = document.querySelector("#product_content"),
    formTitle2 = document.querySelector("#product_title2"),
    formDescription2 = document.querySelector("#product_description2"),
    formContent2 = document.querySelector("#product_content2");
